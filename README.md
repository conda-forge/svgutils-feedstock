About svgutils-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/svgutils-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/btel/svg_utils

Documentation: https://svgutils.readthedocs.io
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4365&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/svgutils-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `svgutils` can be installed with `conda`:
...
```
mamba install svgutils
```

It is possible to list all of the versions of `svgutils` available on your platform with `conda`:
...
```
mamba search svgutils --channel conda-forge
```
...
mamba repoquery search svgutils --channel conda-forge

# List packages depending on `svgutils`:
mamba repoquery whoneeds svgutils --channel conda-forge

# List dependencies of `svgutils`:
mamba repoquery depends svgutils --channel conda-forge
```
